  ...
  return (
    <div className="bg-[#dee13e] w-full px-4 md:px-6 py-4 md:py-6">
      <div className="flex flex-col h-full justify-between relative">
        ...
        {/* Contact Information */}
        <div className="flex flex-col justify-center items-center mt-8 md:mt-[79px]">
          <div className="flex flex-col space-y-4 md:space-y-6 text-base md:text-[30px] text-[#474cba] font-extrabold leading-relaxed tracking-[-0.04em] font-[Poppins] text-center md:text-left md:mt-[-170px]">
            <div>
