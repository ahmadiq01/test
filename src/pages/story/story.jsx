            ...
            <div className="container mx-auto px-6 lg:px-20 mt-10 relative ">
                <div className="relative">
                    <img 
                        ...
                        className="
                            absolute 
                            w-[142px] h-[90px] top-[990px] left-[45px] rotate-[-8.5deg] 
                    ...
                    <img 
                        ...
                        className="
                            absolute 
                            w-[142px] h-[55px] top-[944px] left-[235px] rotate-[18.5deg] 
                    ...
                    <img 
                        ...
                        className="
                            absolute 
                            w-[142px] h-[120px] top-[1100px] left-[167px] rotate-[3deg]
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                    ...
                    <div className="">
                        ...
                        <div className="flex flex-col items-center space-y-8">
                            ...
                            <div className="flex items-center flex-col col-1 space-x-6 md:mt-[60px] mr-[-10px] mb-[-50px] md:ml-[140px]">
                            ...
                            {/* Team Member: Sajjad */}
                            <div className="flex items-center flex-col self-end space-y-3 md:mr-[20px] mr-[-10px] md:mt-[-40px]">
                            ...
                            {/* Team Member: Faizan */}
                            <div className="flex  md:mr-[108px] md:mt-[-175px] md:mb-[10px] mr-[188px] mt-[-105px] mb-[20px] items-center flex-col col-1 space-x-6">
