          ...
          <div className="lg:w-1/2 md:hidden container mx-auto px-6 lg:px-20 mt-10 relative">
            <div className="relative">
              <img
                ...
                className="
                absolute 
                w-[142px] h-[75px] top-[128px] left-[9px] rotate-[-6.5deg] 
              ...
              <img
                ...
                className="
                absolute 
                w-[142px] h-[45px] top-[75px] left-[206px] rotate-[16deg] 
              ...
              <img
                ...
                alt="Vector 3"
                className="
                absolute w-[132px] h-[50px] top-[270px] left-[130px] rotate-[3deg]
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10 w-full">
                <div className="w-full">
                  <div className="flex flex-col items-center space-y-8 w-full md:mt-[-220px]">
                    <div className="flex items-center flex-col space-x-6 md:mt-[10px] mr-[-190px] mb-[-50px] md:ml-[30px]">
                    ...
                    <div className="flex items-center flex-col self-end space-y-3 md:mr-[-250px] mt-[12px] mr-[-85px] md:mt-[-10px]">
                    ...
                    <div className="flex md:mr-[190px] md:mt-[-225px] md:mb-[0px] mr-[06px] mt-[-155px] mb-[20px] items-center flex-col space-x-6">
