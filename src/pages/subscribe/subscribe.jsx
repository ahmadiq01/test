...
const Home = () => {
  ...
  const faqs = [
    {
      ...
      answer: "Yes! We offer special discounts for users who subscribe annually or for multiple years. "
    ...
    },
    {
      ...
      answer: "Yes! Our services are available 24/7, including weekends and public holidays, ensuring uninterrupted access.",
    },
    {
    ...
    },
    {
      ...
      answer: "We support payments via major credit cards, PayPal, and direct bank transfers. "
        + "For enterprise clients, we also offer invoicing options for bulk purchases.",
    },
    {
      question: "Do you offer refunds?",
      answer: "Yes! We provide a 14-day money-back guarantee. If you're not satisfied within the first 14 days, "
  ...
  return (
    <div className="flex flex-col bg-[#dee13e] min-h-screen">
      ...
      {/* Hero Section */}
      <div className="flex-grow flex flex-col items-center justify-center text-center bg-red-500 py-10">
        <div className="w-full font-[Heathergreen] font-normal">
          <p className="font-semibold md:text-[150px] line-height-50px ">Find the Right Plan</p>
          <p className="text-[20px] md:text-[24px] px-4">
            Choose from a variety of plans that suit your needs and budget. Whether you're an individual or a business, we have a plan for you.
          </p>
        </div>
      </div>

      {/* Pricing Plans Section */}
      <div className="bg-[#dee13e] min-h-screen flex items-center justify-center px-6 py-10">
      ...
      <div className="bg-[#dee13e] py-10 flex flex-col items-center">
        <h2 className="text-black font-bold text-5xl mb-10">Plan Comparison</h2>
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-5 gap-6 items-start">
          ...
          <div className="bg-black text-white rounded-xl shadow-lg p-6 w-full">
            <h3 className="text-xl font-bold text-center border-b border-white pb-4">Features</h3>
          ...
          {plans.map((plan, index) => (
            <div key={index} className="text-black text-center">
              ...
              <ul className="space-y-4">
                {features.map((_, idx) => (
                  <li key={idx} className="text-xl">✅</li>
                ))}
              </ul>
            </div>
          ))}
      ...
      <div className="bg-[#914A8E] py-16 px-5 flex flex-col items-center">
        ...
        <div className="w-full max-w-2xl space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="bg-transparent border-b border-white text-white text-lg font-semibold cursor-pointer p-4">
              ...
              {openIndex === index && (
                <p className="text-white text-base font-normal mt-2">{faq.answer}</p>
              )}
            </div>
          ))}
        </div>
