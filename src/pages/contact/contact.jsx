    ...
    <div className="relative min-h-screen ">
      ...
      <div className="flex flex-row sm:flex-row md:flex-col items-center bg-[#dee13e] w-full sm:w-1/2 md:w-[30%] lg:w-[15%] p-6 md:rounded-t-2xl space-y-6 sm:space-y-0 sm:space-x-4 md:space-x-0 md:ml-[45px]">
        <div className="flex flex-col items-center sm:items-start">
          <p className="text-[55px] md:text-[50px] lg:text-[50px] xl:text-[69px] mt-[-30px] md:font-semi-bold font-semi-bold font-[Heathergreen] md:tracking-wider tracking-[px] mr-[14px]  md:mr-[1px] md:scale-y-125 scale-y-145">
            LET'S CONNECT.
          </p>
      ...
      <div className="w-full sm:w-1/2 md:w-[60%] lg:w-[65%] p-4 md:p-8 md:ml-[75px]">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12">
          ...
          <fieldset className="col-span-2 md:col-span-1 lg:col-span-1">
            ...
            <div className="grid grid-cols-2 md:grid-cols-1 lg:grid-cols-1 gap-2 text-gray-700">
              <label><input type="radio" name="budget" value="250-1000" className="mr-2" onChange={handleChange} checked={formData.budget === "250-1000"} /> $250-$1000</label>
              <label><input type="radio" name="budget" value="1000-2000" className="mr-2" onChange={handleChange} checked={formData.budget === "1000-2000"} /> $1000-$2000</label>
              <label><input type="radio" name="budget" value="2000-5000" className="mr-2" onChange={handleChange} checked={formData.budget === "2000-5000"} /> $2000-$5000</label>
              <label><input type="radio" name="budget" value="5000-10000" className="mr-2" onChange={handleChange} checked={formData.budget === "5000-10000"} /> $5000-$10000</label>
            </div>
          </fieldset>

          <button 
            type="submit" 
            className={`bg-[#474cba] text-white py-3 md:py-5 px-6 md:px-10 rounded-full w-full md:w-1/4 hover:bg-blue-700 col-span-2 mt-4 md:mt-6 text-base md:text-lg ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
